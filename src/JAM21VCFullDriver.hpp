...
#ifndef __JAM21VCFULL_MO_DRIVER_HPP__
#define __JAM21VCFULL_MO_DRIVER_HPP__

#include "GenMCDriver.hpp"

class JAM21VCFullDriver : public GenMCDriver {

public:
	JAM21VCFullDriver(std::shared_ptr<const Config> conf, std::unique_ptr<llvm::Module> mod,
...
#endif /* __JAM21VCFULL_MO_DRIVER_HPP__ */
