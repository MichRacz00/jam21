 ...
 */
 ...
 JAM21VCFullDriver::JAM21VCFullDriver(std::shared_ptr<const Config> conf, std::unique_ptr<llvm::Module> mod,
 ...
 View JAM21VCFullDriver::calcBasicHbView(Event e) const
 {
 ...
 View JAM21VCFullDriver::calcBasicPorfView(Event e) const
 {
 ...
 void JAM21VCFullDriver::calcBasicViews(EventLabel *lab)
 {
 ...
 void JAM21VCFullDriver::calcReadViews(ReadLabel *lab)
 {
	 const auto &g = getGraph();
	 View hb = calcBasicHbView(lab->getPos());
	 View porf = calcBasicPorfView(lab->getPos());
 ...
 void JAM21VCFullDriver::calcWriteViews(WriteLabel *lab)
 {
	 calcBasicViews(lab);
 ...
 void JAM21VCFullDriver::calcWriteMsgView(WriteLabel *lab)
 {
	 const auto &g = getGraph();
	 View msg;
 ...
 void JAM21VCFullDriver::calcRMWWriteMsgView(WriteLabel *lab)
 {
	 const auto &g = getGraph();
	 View msg;
 ...
 void JAM21VCFullDriver::calcFenceRelRfPoBefore(Event last, View &v)
 {
	 const auto &g = getGraph();
 ...
 void JAM21VCFullDriver::calcFenceViews(FenceLabel *lab)
 {
	 const auto &g = getGraph();
	 View hb = calcBasicHbView(lab->getPos());
	 View porf = calcBasicPorfView(lab->getPos());
 ...
 void JAM21VCFullDriver::calcStartViews(ThreadStartLabel *lab)
 {
	 const auto &g = getGraph();
 ...
 void JAM21VCFullDriver::calcJoinViews(ThreadJoinLabel *lab)
 {
	 const auto &g = getGraph();
 ...
 void JAM21VCFullDriver::updateLabelViews(EventLabel *lab, const EventDeps *deps) /* deps ignored */
 {
	 const auto &g = getGraph();
 ...
 bool JAM21VCFullDriver::areInDataRace(const MemAccessLabel *aLab, const MemAccessLabel *bLab)
 {
 ...
 Event JAM21VCFullDriver::findRaceForNewLoad(const ReadLabel *rLab)
 {
	 const auto &g = getGraph();
 ...
 Event JAM21VCFullDriver::findRaceForNewStore(const WriteLabel *wLab)
 {
	 const auto &g = getGraph();
 ...
 Event JAM21VCFullDriver::findDataRaceForMemAccess(const MemAccessLabel *mLab)
 {
 ...
 void JAM21VCFullDriver::changeRf(Event read, Event store)
 {
	 auto &g = getGraph();
 ...
 void JAM21VCFullDriver::updateStart(Event create, Event start)
 {
	 auto &g = getGraph();
 ...
 bool JAM21VCFullDriver::updateJoin(Event join, Event childLast)
 {
	 auto &g = getGraph();
 ...
 void JAM21VCFullDriver::initConsCalculation()
 {
	 return;
 }
