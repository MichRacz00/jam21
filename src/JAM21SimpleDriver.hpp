...
#ifndef __JAM21SIMPLE_DRIVER_HPP__
#define __JAM21SIMPLE_DRIVER_HPP__

#include "GenMCDriver.hpp"

class JAM21SimpleDriver : public GenMCDriver {

public:
	JAM21SimpleDriver(std::shared_ptr<const Config> conf, std::unique_ptr<llvm::Module> mod,
...
#endif /* __JAM21SIMPLE_DRIVER_HPP__ */
