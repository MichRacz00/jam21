...
std::vector<SAddr> VOCalculator::getDoubleLocs() const
{
	auto &g = getGraph();
...
std::vector<Event> VOCalculator::calcSCFencesSuccs(const std::vector<Event> &fcs,
						     const Event e) const
{
	auto &g = getGraph();
...
std::vector<Event> VOCalculator::calcSCFencesPreds(const std::vector<Event> &fcs,
						     const Event e) const
{
	auto &g = getGraph();
	auto &hbRelation = g.getGlobalRelation(ExecutionGraph::RelationId::hb);
...
std::vector<Event> VOCalculator::calcSCSuccs(const std::vector<Event> &fcs,
					       const Event e) const
{
	auto &g = getGraph();
...
std::vector<Event> VOCalculator::calcSCPreds(const std::vector<Event> &fcs,
					       const Event e) const
{
	auto &g = getGraph();
	const EventLabel *lab = g.getEventLabel(e);
...
std::vector<Event> VOCalculator::calcRfSCSuccs(const std::vector<Event> &fcs,
...
std::vector<Event> VOCalculator::calcRfSCFencesSuccs(const std::vector<Event> &fcs,
						       const Event ev) const
{
	auto &g = getGraph();
	const EventLabel *lab = g.getEventLabel(ev);
...
void VOCalculator::addRbEdges(const std::vector<Event> &fcs,
...
void VOCalculator::addMoRfEdges(const std::vector<Event> &fcs,
				  const std::vector<Event> &moAfter,
				  const std::vector<Event> &moRfAfter,
				  Calculator::GlobalRelation &matrix,
				  const Event &ev) const
 ...
 */
void VOCalculator::addSCEcosLoc(const std::vector<Event> &fcs,
 ...
 * addSCEcos()).
 */
void VOCalculator::addSbHbEdges(Calculator::GlobalRelation &matrix) const
{
	auto &g = getGraph();
	auto &hbRelation = g.getGlobalRelation(ExecutionGraph::RelationId::hb);
...
void VOCalculator::addInitEdges(const std::vector<Event> &fcs,
...
void VOCalculator::addSCEcos(const std::vector<Event> &fcs,
...
void VOCalculator::calcPscRelation()
{
	auto &g = getGraph();
