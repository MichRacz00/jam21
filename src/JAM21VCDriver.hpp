...
#ifndef __JAM21VC_MO_DRIVER_HPP__
#define __JAM21VC_MO_DRIVER_HPP__

#include "GenMCDriver.hpp"

class JAM21VCDriver : public GenMCDriver {

public:
	JAM21VCDriver(std::shared_ptr<const Config> conf, std::unique_ptr<llvm::Module> mod,
...
#endif /* __JAM21VC_MO_DRIVER_HPP__ */
