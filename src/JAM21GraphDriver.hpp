...
#ifndef __JAM21GRAPH_DRIVER_HPP__
#define __JAM21GRAPH_DRIVER_HPP__

#include "GenMCDriver.hpp"

class JAM21GraphDriver : public GenMCDriver {

public:
	JAM21GraphDriver(std::shared_ptr<const Config> conf, std::unique_ptr<llvm::Module> mod,
...
#endif /* __JAM21GRAPH_DRIVER_HPP__ */
